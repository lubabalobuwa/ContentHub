...
namespace ContentHub.Application.Common.Interfaces
{
    public interface IContentReadRepository
    {
        ...
        Task<PagedResult<ContentItem>> GetArchivedAsync(int page, int pageSize, string? search);
        Task<PagedResult<ContentItem>> GetArchivedByAuthorAsync(Guid authorId, int page, int pageSize);
        Task<PagedResult<ContentItem>> GetDraftsAsync(int page, int pageSize, string? search);
        ...
        Task<PagedResult<ContentItem>> GetPublishedAsync(int page, int pageSize, string? search);
    }
}
